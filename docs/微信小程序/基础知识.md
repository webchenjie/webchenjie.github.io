...
23. 按需注入和用时注入 // https://developers.weixin.qq.com/miniprogram/dev/framework/ability/lazyload.html
24. 接口调用频率限制 // https://developers.weixin.qq.com/miniprogram/dev/framework/performance/api-frequency.html
25. 性能与体验 // https://developers.weixin.qq.com/miniprogram/dev/framework/performance/
```
