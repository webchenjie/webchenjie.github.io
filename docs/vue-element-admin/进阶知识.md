...
# 路由
![路由逻辑图](https://6368-chenjie-blog-88b4b7-1302547066.tcb.qcloud.la/vue-element-admin-router1.png)
``` js
// 路由场景分析,中后台路由常见的常见如下:
1. 已获取 Token:
    访问 /login:重定向到 /
...
# 动态路由
![动态路由逻辑图](https://6368-chenjie-blog-88b4b7-1302547066.tcb.qcloud.la/vue-element-admin-router2.png)
``` js
