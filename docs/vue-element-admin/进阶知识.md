...
# 路由
![vue-element-admin](https://6368-chenjie-blog-88b4b7-1302547066.tcb.qcloud.la/docs/vue-element-admin/进阶知识/路由.png)
``` js
// 路由场景分析,中后台路由常见的常见如下:
1. 已获取 Token:
    访问 /login:重定向到 /
...
# 动态路由
![vue-element-admin](https://6368-chenjie-blog-88b4b7-1302547066.tcb.qcloud.la/docs/vue-element-admin/进阶知识/动态路由.png)
``` js
