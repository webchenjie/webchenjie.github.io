...
<img src="/image/blogs/技术/20211218/blogs-技术-20211218-1.png" style="zoom:67%;" />
...
<img src="/image/blogs/技术/20211218/blogs-技术-20211218-2.png" style="zoom:67%;" />
...
<img src="/image/blogs/技术/20211218/blogs-技术-20211218-3.png" style="zoom:67%;" />
...
1. 在 `VSCode` 中安装 `prettier` 插件（搜索 `prettier`），这个插件可以帮助我们在配置 `prettier` 的时候获得提示
   <img src="/image/blogs/技术/20211218/blogs-技术-20211218-4.png" style="zoom:50%;" />
...
4. 打开 `VSCode` 《设置面板》
   <img src="/image/blogs/技术/20211218/blogs-技术-20211218-5.png" style="zoom:67%;" />

5. 在设置中，搜索 `save` ，勾选 `Format On Save`
   <img src="/image/blogs/技术/20211218/blogs-技术-20211218-6.png" style="zoom:67%;" />
...
<img src="/image/blogs/技术/20211218/blogs-技术-20211218-7.png" style="zoom:67%;" />
...
![image-20210904203051754](/image/blogs/技术/20211218/blogs-技术-20211218-8.png)
...
<img src="/image/blogs/技术/20211218/blogs-技术-20211218-9.png" />
...
![image-20210710121456416](/image/blogs/技术/20211218/blogs-技术-20211218-10.png)
...
2. 启动 `hooks` ， 生成 `.husky` 文件夹
    ...
    ![image-20210906202034156](/image/blogs/技术/20211218/blogs-技术-20211218-11.png)
...
3. 在 `package.json` 中生成 `prepare` 指令（ **需要 npm > 7.0 版本** ）
    ...
    <img src="/image/blogs/技术/20211218/blogs-技术-20211218-12.png" style="zoom:50%;" />
...
5. 执行成功，提示
   <img src="/image/blogs/技术/20211218/blogs-技术-20211218-13.png" style="zoom:80%;" />
...
7. 此时的 `.husky` 的文件结构
   ![image-20210710120228931](/image/blogs/技术/20211218/blogs-技术-20211218-14.png)
...
2. 该操作会生成对应文件 `pre-commit`：
   ![image-20210906204043915](/image/blogs/技术/20211218/blogs-技术-20211218-15.png)
...
![image-20210717190311264](/image/blogs/技术/20211218/blogs-技术-20211218-16.png)
...
![image-20210717190629024](/image/blogs/技术/20211218/blogs-技术-20211218-17.png)

2. 重启 `VSCode`

按以上两种方式执行之后，你的多根元素就不会出现不好看的错误了
<img src="/image/blogs/技术/20211218/blogs-技术-20211218-18.png" style="zoom:50%;" />
